...
public class Client {
    ...
    private static final String LOGS_DIR =
            System.getProperty("user.dir") + "\\src\\clients\\logs";
    ...
    public static ServerObjectInterface client = null;
...
//        }
        ...
        try {
            client =   ServerObjectInterfaceHelper.narrow(ncRef.resolve_str("FrontEnd"));
        } catch (NotFound e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        ...
        try {
            if (isAdmin) {
                ...
                showAdminMainMenu(clientID,client, clientFromServer);
                ...
                //-----
                showCustomerMainMenu(clientID, client);
            }
            //                while (true) {
        ...
        while (choice != 4) {
            ...
            switch (choice) {
                case 1:
                    ...
                    try {
                        res = server.addMovieSlots(clientID,movieID, movieName, bookingCapacity);
                    } catch (Exception e) {
                        msg =
                ...
                case 2:
                    ...
                    try {
                        res = server.removeMovieSlots(clientID,movieID, movieName);
                    } catch (Exception e) {
                        msg =
                                new utils.Logger.CustomMessage(
                                        "removeMovieSlots",
                ...
                case 3:
                    ...
                    try {
                        res = server.listMovieShowsAvailability(clientID,movieName);
                    } catch (Exception e) {
                        msg =
                                new utils.Logger.CustomMessage(
