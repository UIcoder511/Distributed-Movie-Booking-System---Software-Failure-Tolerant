      ...
      case 1:
        {
          ...
          System.out.println(
            "Please enter slot(Morning, Afternoon, Evening): "
          );
      ...
      case 4:
        {
          ...
          String response = admin.bookMovieTickets(
            userNameC,
            movie.getMovieId(),
            movie.getName(),
            numberOfTickets
      ...
      case 5:
        {
          ...
          System.out.println(response);
          LOGGER.info(
            "request to getBookingSchedule for customer: " + response
          );
          break;
        }
      ...
      case 6:
        {
          ...
          String response = admin.cancelMovieTickets(
            userNameC,
            movie.getMovieId(),
            movie.getName(),
            numberOfTickets
          ...
          System.out.println(response);
          LOGGER.info(
            "request to cancel Movie tickets for customer: " + response
          );
          break;
        }
      case 7:
