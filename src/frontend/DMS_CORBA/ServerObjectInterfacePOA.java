...
public abstract class ServerObjectInterfacePOA
  extends org.omg.PortableServer.Servant
  implements
    ServerObjectInterfaceOperations, org.omg.CORBA.portable.InvokeHandler {
  ...
  public org.omg.CORBA.portable.OutputStream _invoke(
    ...
    if (__method == null) throw new org.omg.CORBA.BAD_OPERATION(
      0,
  ...
  private static String[] __ids = { "IDL:DMS_CORBA/ServerObjectInterface:1.0" };
  ...
  public ServerObjectInterface _this() {
    return ServerObjectInterfaceHelper.narrow(super._this_object());
  }

  public ServerObjectInterface _this(org.omg.CORBA.ORB orb) {
    return ServerObjectInterfaceHelper.narrow(super._this_object(orb));
  }
